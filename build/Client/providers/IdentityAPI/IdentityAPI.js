...
const getIdentity_1 = __importDefault(require("./methods/getIdentity"));
const getToken_1 = __importDefault(require("./methods/getToken"));
const createIdentity_1 = __importDefault(require("./methods/createIdentity"));
/**
